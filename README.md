...
- [Foundation & Pre-trained Models](#foundation--pre-trained-models)
...
- [Litigation & Dispute Resolution](#litigation--dispute-resolution)
  - [Judgment Prediction](#judgment-prediction)
  - [Courtroom Simulation](#courtroom-simulation)
...
- **SaulLM-7B: A pioneering Large Language Model for Law**, arXiv 2024. [[Paper](https://arxiv.org/abs/2403.03883)]
- **LEGAL-BERT: The Muppets straight out of Law School**, EMNLP 2020. [[Paper](https://aclanthology.org/2020.findings-emnlp.261.pdf)] [[Code](https://github.com/nlpaueb/legal-bert)]
- **ChatLaw: A Multi-Agent Collaborative Legal Large Language Model with Knowledge Graph and Mixture-of-Experts**, arXiv 2023. [[Paper](https://arxiv.org/abs/2306.16092)] [[Code](https://github.com/PKU-YuanGroup/ChatLaw)]
- **LawGPT: A Chinese Legal Knowledge-Enhanced Large Language Model**, arXiv 2024. [[Paper](https://arxiv.org/abs/2406.04614)]
- **Lawyer GPT: A Legal Large Language Model with Enhanced Domain Knowledge and Reasoning Capabilities**, ICAIL 2024. [[Paper](https://dl.acm.org/doi/abs/10.1145/3689299.3689319)]
- **InternLM-Law: An Open-Sourced Chinese Legal Large Language Model**, COLING 2025. [[Paper](https://aclanthology.org/2025.coling-main.629/)]
...
- **Intro to retrieval-augmented generation (RAG) in legal tech**, Thomson Reuters 2024. [[Blog](https://legal.thomsonreuters.com/blog/retrieval-augmented-generation-in-legal-tech/)]
...
- **AI-Powered Lawyering: AI Reasoning Models, Retrieval-Augmented Generation, and the Future of Legal Practice**, 2025. [[Paper](https://www.governance.ai/research-paper/ai-powered-lawyering-ai-reasoning-models-retrieval-augmented-generation-and-the-future-of-legal-practice)]
...
- **Text-guided Legal Knowledge Graph Reasoning**, K-GALS 2021. [[Paper](https://arxiv.org/abs/2104.02284)]
- **Construction of Legal Knowledge Graph Based on Large Language Model**, MDPI 2024. [[Paper](https://www.mdpi.com/2078-2489/15/11/666)]
...
- **CourtPrp - AI Courtroom Simulator**. [[Website](https://courtprp.com/)]
- **VR Legal Training & Virtual Courtroom Simulation**. [[Website](https://www.simlab-soft.com/use_cases/simlab-vr-law-court.aspx)]

### Argument Mining

- **Large Language Models in Argument Mining: A Survey**, arXiv 2025. [[Paper](https://arxiv.org/html/2506.16383v1)]
- **Approaches to Text Mining Arguments from Legal Cases**. [[Paper](https://people.cs.pitt.edu/~huynv/research/argument-mining/Approaches%20to%20text%20mining%20arguments%20from%20legal%20cases.pdf)]
...
- **AI Contract Analysis: A Comprehensive Guide for Legal Teams**, Sirion 2026. [[Article](https://www.sirion.ai/library/contract-analytics/ai-contract-analysis/)]
- **Automated generation of smart contract code from legal contract specifications with Symboleo2SC**, Software and Systems Modeling 2025. [[Paper](https://link.springer.com/article/10.1007/s10270-024-01187-9)]
- **Legal text summarization via judicial syllogism with large language models**, Journal of King Saud University 2025. [[Paper](https://link.springer.com/article/10.1007/s44443-025-00113-3)]
...
- **Workflow automation for legal teams: How Flank is empowering lawyers with an autonomous AI agent**, Insight Partners 2025. [[Article](https://www.insightpartners.com/ideas/workflow-automation-for-legal-teams-how-flank-is-empowering-law-yers-with-an-autonomous-ai-agent/)]
...
- **Named Entity Recognition in the Legal Domain**, RelationalAI 2022. [[Blog](https://www.relational.ai/post/named-entity-recognition-in-the-legal-domain)]

## Benchmarks & Evaluation

- **LegalBench: An open science effort to collaboratively curate tasks for evaluating legal reasoning in English large language models**. [[GitHub](https://github.com/HazyResearch/legalbench)]
- **LawBench: Benchmarking Legal Knowledge of Large Language Models**, EMNLP 2024. [[Paper](https://aclanthology.org/2024.emnlp-main.452.pdf)]
...
- **CoCounsel (Casetext/Thomson Reuters)**: AI legal assistant for research, document review, and more. [[Website](https://casetext.com/cocounsel/)]
- **Spellbook**: AI contract drafting and review tool. [[Website](https://www.spellbook.legal/)]
- **DISCO**: AI-powered ediscovery software. [[Website](https://csdisco.com/)]
- **Reveal**: AI-driven eDiscovery platform. [[Website](https://www.revealdata.com/)]
- **eDiscovery AI**: Data Intelligence & Legal Tech Solutions. [[Website](https://ediscoveryai.com/)]
- **Compliance.ai**: Financial and Regulatory Compliance Software. [[Website](https://www.compliance.ai/)]

## Datasets & Corpora

- **Pile of Law**: A 256GB dataset of open-source English-language legal and administrative data. [[Paper](https://arxiv.org/abs/2109.02765)]
- **MultiLegalPile**: A 689GB corpus in 24 languages from 17 jurisdictions. [[Paper](https://arxiv.org/abs/2210.15915)]
- **LexGLUE**: A benchmark dataset for legal language understanding in English. [[Kaggle](https://www.kaggle.com/datasets/thedevastator/lexglue-legal-nlp-benchmark-dataset)]
- **openlegaldata/awesome-legal-data**: A curated list of resources dedicated to legal data. [[GitHub](https://github.com/openlegaldata/awesome-legal-data)]
...
@misc{awesome-world-law-agent,
  ...
  howpublished = {\url{https://github.com/manus-ai/awesome-world-law-agent}}
}
```
